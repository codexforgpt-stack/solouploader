...
# Pyromod 3.1.6 handles listener initialization automatically
...
photologo = 'https://i.ibb.co/23vqX8cW/image.png'
photoyt = 'https://i.ibb.co/NgykzgXQ/image.png'
photocp = 'https://i.ibb.co/XkSyrm62/Chat-GPT-Image-Jan-22-2026-06-37-41-PM.png'
photozip = 'https://i.ibb.co/Gf3jTJbS/image2.jpg'



# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/solobst_bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/solobst_bot")        ],
    ]
)

# Image URLs for the random image feature
image_urls = [
    "https://i.ibb.co/23vqX8cW/image.png",
    "https://i.ibb.co/NgykzgXQ/image.png",
    "https://i.ibb.co/XkSyrm62/Chat-GPT-Image-Jan-22-2026-06-37-41-PM.png",
    "https://i.ibb.co/Gf3jTJbS/image2.jpg",
]
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        "<b>Mʏ Nᴀᴍᴇ [ꜱᴏʟᴏ ʙᴇᴀsᴛ 🦋](https://t.me/solobst_bot)</b>\n\n"
        ...
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access", url="https://t.me/solobst_bot")
        ]])
    )
...
async def txt_handler(bot: Client, m: Message):  
    ...
    input: Message = await bot.listen(editable.chat.id, timeout=300)  # 5 minute timeout
...
@bot.on_message(filters.text & filters.private & ~filters.regex(r"^/"))  # Exclude commands using regex
...
async def details_callback(client, callback_query: CallbackQuery):
    ...
    details_text = (
        "**📋 Bot Details 📋**\n\n"
        "• 🤖 Bot Name: Solo Beast Bot 🦋\n"
        "• 👨‍💻 Developer: Solo Beast\n"
        "• 📱 Contact: @solobst_bot\n"
        "• 🔄 Version: 1.0\n"
        "• 📝 Language: Python\n"
