...
class Database:
    ...
    def _print_startup_message(self):
        ...
        print(f"\n{Fore.CYAN}{'='*50}")
        print(f"{Fore.CYAN}[INIT] 𝐒𝐨𝐥𝐨 𝐁𝐞𝐚𝐬𝐭 Bot - Database Initialization")
    ...
    def get_user(self, user_id: int, bot_username: str = "Solo Beast") -> Optional[dict]:
        """
    ...
    def is_user_authorized(self, user_id: int, bot_username: str = "Solo Beast") -> bool:
        """
    ...
    def add_user(self, user_id: int, name: str, days: int, 
                bot_username: str = "Solo Beast") -> tuple[bool, Optional[datetime]]:
        """
    ...
    def remove_user(self, user_id: int, bot_username: str = "Solo Beast") -> bool:
        """
    ...
    def list_users(self, bot_username: str = "Solo Beast") -> List[dict]:
        """
    ...
    def list_bot_usernames(self) -> List[str]:
        ...
        try:
            ...
            return usernames if usernames else ["Solo Beast"]
        except Exception as e:
    ...
    def get_user_expiry_info(self, user_id: int, bot_username: str = "Solo Beast") -> Optional[dict]:
        """
...
# Startup Message
print(f"\n{Fore.CYAN}{'='*50}")
print(f"🤖 Initializing 𝐒𝐨𝐥𝐨 𝐁𝐞𝐚𝐬𝐭 Bot Database")
print(f"{'='*50}{Style.RESET_ALL}\n")

# [DB] Connect to DB with error handling
try:
