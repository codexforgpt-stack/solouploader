...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="https://i.ibb.co/23vqX8cW/image.png">
    <!-- Bootstrap CSS -->
...
╚══██╔══╝██║  ██║██╔══██╗████╗  ██║██╔═══██╗██╔════╝
   ...
   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚══════╝
    ...
    <footer>
        <center>
            <img src="https://i.ibb.co/NgykzgXQ/image.png" width="40" height="40">
            Powered By Thanos 
            <img src="https://i.ibb.co/XkSyrm62/Chat-GPT-Image-Jan-22-2026-06-37-41-PM.png" width="40" height="40">
